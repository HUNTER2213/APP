...
namespace PUBGMESP
{
    internal class Algorithms
    {
        ...
        /// <returns></returns>
        public static Vector3 GetBoneWorldPosition(long actorAddv, long boneAddv)
        {
        ...
        /// <returns></returns>
        public static bool WorldToScreenPlayer(D3DMatrix viewMatrix, Vector3 pos, out Vector3 screen, out int distance, int windowWidth, int windowHeight)
        {
            screen = new Vector3();
        ...
        /// <param name="windowHeight"></param>
        /// <returns></returns>
        public static bool WorldToScreenBone(D3DMatrix viewMatrix, Vector3 pos, out Vector2 screen, out int distance, int windowWidth, int windowHeight)
        ...
        /// <param name="windowHeight"></param>
        /// <returns></returns>
        public static bool WorldToScreenItem(D3DMatrix viewMatrix, Vector3 pos, out Vector2 screen, out int distance, int windowWidth, int windowHeight)
        {
            screen = new Vector2();
            float screenW = (viewMatrix._14 * pos.X) + (viewMatrix._24 * pos.Y) + (viewMatrix._34 * pos.Z + viewMatrix._44);
            distance = (int)(screenW / 100);
