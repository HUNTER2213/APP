...
namespace PUBGMESP
{
    public partial class MainForm : Form
    {
        ...
        const string WINDOW_NAME_G = "Gameloop【Turbo AOW Engine】";
            ...
            while (true)
            {
                ...
                for (int i = 0; i < entityCount; i++)
                {
                    ...
                    if (Settings.PlayerESP)
                    {
                        ...
                        if (GameData.IsPlayer(entityType))
                        {
                            ...
                            PlayerData playerData = new PlayerData
                            {
                                Type = entityType,
                                Address = entityAddv,
                                Position = Mem.ReadMemory<Vector3>(playerWorld + posOffset),
                                Status = status,
                    ...
                    if (Settings.ItemESP)
                    {
                        ...
                        if (item != Item.Useless)
                        {
                            ...
                            ItemData itemData = new ItemData
                            {
                                ...
                                Position = Mem.ReadMemory<Vector3>(Mem.ReadMemory<int>(entityAddv + 312) + posOffset),
                                Type = item
                            };
                        ...
                        if (GameData.IsBox(entityType))
                        {
                            ...
                            boxData.Position = Mem.ReadMemory<Vector3>(boxEntity + posOffset);
                            boxList.Add(boxData);
                            continue;
                        }
                    }
                    ...
                    if (grenade != Grenade.Unknown)
                    {
                        ...
                        {
                            Type = grenade,
                            Position = Mem.ReadMemory<Vector3>(grenadeEntity + posOffset)
                        };
